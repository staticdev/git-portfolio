...
def test_command_config_check_no_repos(
    mock_config_manager: MockerFixture, runner: CliRunner
) -> None:
...
def test_add_success(
    ...
    """It calls add."""
    runner.invoke(git_portfolio.__main__.main, ["add", "."], prog_name=CLI_COMMAND)
...
def test_branch_success(
    ...
    """It calls branch."""
    runner.invoke(git_portfolio.__main__.main, ["branch", "-a"], prog_name=CLI_COMMAND)
...
def test_commit_success(
    ...
    runner.invoke(
        git_portfolio.__main__.main, ["commit", "-m", "message"], prog_name=CLI_COMMAND
    )
...
def test_diff_success(
    ...
    """It calls diff."""
    runner.invoke(git_portfolio.__main__.main, ["diff"], prog_name=CLI_COMMAND)
...
def test_fetch_success(
    ...
    """It calls fetch."""
    runner.invoke(git_portfolio.__main__.main, ["fetch"], prog_name=CLI_COMMAND)
...
def test_init_success(
    ...
    """It calls init."""
    runner.invoke(git_portfolio.__main__.main, ["init"], prog_name=CLI_COMMAND)
...
def test_merge_success(
    ...
    """It calls merge."""
    runner.invoke(git_portfolio.__main__.main, ["merge"], prog_name=CLI_COMMAND)
...
def test_mv_success(
    ...
    """It calls mv."""
    runner.invoke(git_portfolio.__main__.main, ["mv"], prog_name=CLI_COMMAND)
...
def test_pull_success(
    ...
    """It calls pull."""
    runner.invoke(git_portfolio.__main__.main, ["pull"], prog_name=CLI_COMMAND)
...
def test_push_success(
    ...
    runner.invoke(
        git_portfolio.__main__.main, ["push", "origin", "main"], prog_name=CLI_COMMAND
    )
...
def test_rebase_success(
    ...
    """It calls rebase."""
    runner.invoke(git_portfolio.__main__.main, ["rebase"], prog_name=CLI_COMMAND)
...
def test_reset_success_with_hard(
    ...
    runner.invoke(
        git_portfolio.__main__.main, ["reset", "--hard", "HEAD^"], prog_name=CLI_COMMAND
    )
...
def test_rm_success(
    ...
    """It calls rm."""
    runner.invoke(git_portfolio.__main__.main, ["rm"], prog_name=CLI_COMMAND)
...
def test_show_success(
    ...
    """It calls show."""
    runner.invoke(git_portfolio.__main__.main, ["show"], prog_name=CLI_COMMAND)
...
def test_status_success(
    ...
    """It calls status."""
    runner.invoke(git_portfolio.__main__.main, ["status"], prog_name=CLI_COMMAND)
...
def test_switch_success(
    ...
    """It calls switch."""
    runner.invoke(git_portfolio.__main__.main, ["switch"], prog_name=CLI_COMMAND)
...
def test_tag_success(
    ...
    """It calls tag."""
    runner.invoke(git_portfolio.__main__.main, ["tag"], prog_name=CLI_COMMAND)
...
def test_config_init_success(
    ...
    result = runner.invoke(
        git_portfolio.__main__.group_config, ["init"], prog_name=CLI_COMMAND
    )
...
def test_config_repos_success(
    ...
    result = runner.invoke(
        git_portfolio.__main__.group_config, ["repos"], prog_name=CLI_COMMAND
    )
...
def test_clone_success(
    ...
    runner.invoke(git_portfolio.__main__.main, ["clone"], prog_name=CLI_COMMAND)
...
@pytest.mark.parametrize(
    "cli", [git_portfolio.__main__.group_issues, git_portfolio.__main__.group_prs]
)
def test_close_issues(
    ...
    config_manager = mock_config_manager.return_value
    github_service = mock_github_service.return_value
    runner.invoke(cli, ["close"], prog_name=CLI_COMMAND)
...
def test_reopen_issues(
    ...
    config_manager = mock_config_manager.return_value
    github_service = mock_github_service.return_value
    runner.invoke(cli, ["reopen"], prog_name=CLI_COMMAND)
...
def test_create_prs(
    ...
    config_manager = mock_config_manager.return_value
    github_service = mock_github_service.return_value
    runner.invoke(git_portfolio.__main__.group_prs, ["create"], prog_name=CLI_COMMAND)
...
def test_create_prs_service_error(
    ...
    """It raises system exit."""
    result = runner.invoke(
        git_portfolio.__main__.group_prs, ["create"], prog_name=CLI_COMMAND
    )
...
def test_merge_prs(
    ...
    config_manager = mock_config_manager.return_value
    github_service = mock_github_service.return_value
    runner.invoke(git_portfolio.__main__.group_prs, ["merge"], prog_name=CLI_COMMAND)
...
def test_merge_prs_service_error(
    ...
    """It raises system exit."""
    result = runner.invoke(
        git_portfolio.__main__.group_prs, ["merge"], prog_name=CLI_COMMAND
    )
