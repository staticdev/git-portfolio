...
class TestConfigManager:
    ...
    def test_init_invalid_config(self, mock_os_join_path: Mock, tmp_path: Mock) -> None:
    ...
    def test_save_invalid_yaml(self, mock_os_join_path: Mock, tmp_path: Mock) -> None:
        """It trucantes the file."""
    ...
    def test_save_config_no_file(self, mock_os_join_path: Mock, tmp_path: Mock) -> None:
    ...
    def test_save_config_empty_file(
        self, mock_os_join_path: Mock, tmp_path: Mock
    ) -> None:
        """It raises AttributeError."""
    ...
    def test_save_config_success(
        self, mock_yaml_dump: Mock, mock_os_join_path: Mock, tmp_path: Mock
    ) -> None:
